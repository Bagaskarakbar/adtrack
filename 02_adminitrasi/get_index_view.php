<?
	...
	while ($tampil=$rsPaging->FetchRow()) {
		...
		$DataList['details']="<button type='button' id='PopoverCustomT-4' class='btn btn-primary btn-sm'><a href='#' style='color: white; text-decoration: none;' onClick='list_docs_modal($id_tc_pengajuan)'>Detail</a></button>";
		$data['items'][]=$DataList;
	}
