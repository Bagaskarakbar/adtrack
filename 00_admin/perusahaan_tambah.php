...
<div id="isiUtama">
	<div class="modal-header register-modal-head" style="background-color:#2ca4d7">
		<h5 class="modal-title" style="color:white">Tambah Perusahaan Baru</h5>
...
<!-- 			<p aria-hidden="true" id="required-description">
			...
			<div class="row form-group">
				<label class="col-2 col-form-label">Kode Perusahaan</label>
				<div class="col-7">
			...
			<div class="row form-group">
				...
				<div class="col-7">
					<input class="form-control" type="text" value="<?= $contact_person1 ?>" name="contact_person1" tabindex="12" required="required" />
				</div>
			</div>
			<div class="row form-group">
				<label class="col-2 col-form-label">Telepon #2 </label>
				<div class="col-7">
					<input class="form-control" type="text" value="<?= $telepon2 ?>" name="telepon2" tabindex="13" />
				</div>
			</div>
			<div class="row form-group">
				<label class="col-2 col-form-label">Contact Person #2</label>
				<div class="col-7">
					<input class="form-control" type="text" value="<?= $contact_person2?>" name="contact_person2" tabindex="14" />
				</div>
			</div>
			<div class="row form-group">
				<label class="col-2 col-form-label">Faksimili </label>
				<div class="col-7">
					<input class="form-control" type="text" value="<?= $faksimili ?>" name="faksimili" tabindex="15" required="required" />
				</div>
			</div>
			<div class="row form-group">
			...
			<div class="card-footer" style="float: right;">
				...
				<input type="button" value="Submit" class="btn btn-success mr-2" onclick="tambah_perusahaan()"></button>
			</div>
		</form>
