<?
	...
	$i = $pagenya->pagingVars["firstno"];
				...
				while ($tampil=$rsPaging->FetchRow()) {
					...
					$tampil["nama_perusahaan"] = "<a href='#' title='Detail PO' onclick=DetPEN('$kode_perusahaan')>$nama_perusahaan</a>";
					
					$JmlPEN = baca_tabel("po_konf_detail_v as a join mt_peserta_v as b on a.kode_perusahaan_pemesan=b.kode_perusahaan", "COUNT(a.id_tc_po)", "where a.kode_perusahaan='" . $kode_perusahaan . "'");
					
					$tampil["nama"]=$nama_perusahaan;
					$tampil["JmlPEN"]=$JmlPEN;
					$tampil["no"]=$i;
