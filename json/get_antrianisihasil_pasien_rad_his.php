<?
	...
	$i = $pagenya->pagingVars["firstno"];
				...
				while ($tampil=$rsPaging->FetchRow()) {
					...
					$isi_hasil="<span class='label label-primary  label-pill label-inline mr-2' style='cursor:pointer' onClick='History($kode_penunjang)' >History</span>";
					/*================= 		/TR		===================*/
