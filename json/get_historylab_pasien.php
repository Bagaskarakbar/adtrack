<?
	...
	$sql = "select no_antrian,kode_penunjang,nama_pasien,tgl_daftar,b.no_mr,almt_ttp_pasien,diagnosa,url_foto_pasien,id_pm_tc_penunjang from pm_tc_penunjang as a join tc_kunjungan as b on a.no_kunjungan=b.no_kunjungan join mt_master_pasien as c on b.no_mr=c.no_mr where  kode_bagian='050101' $sqlAddSem and tgl_isihasil is not null group by no_antrian,kode_penunjang,nama_pasien,tgl_daftar,b.no_mr,almt_ttp_pasien,diagnosa,url_foto_pasien,id_pm_tc_penunjang" ;
	...
	$i = $pagenya->pagingVars["firstno"];
				...
				while ($tampil=$rsPaging->FetchRow()) {
					...
					$isi_hasil="<span class='label label-primary  label-pill label-inline mr-2' style='cursor:pointer' onClick='isiHasil($kode_penunjang,$no_mrnya)' >Cetak Hasil</span>";
					
					$edit_hasil="<span class='label label-success  label-pill label-inline mr-2' style='cursor:pointer' onClick='editHasil($kode_penunjang,$no_mrnya)' >Edit Hasil</span>";
					/*================= 		/TR		===================*/
