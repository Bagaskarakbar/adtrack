<?
	...
	$sql = "select no_antrian,kode_penunjang,nama_pasien,tgl_daftar,b.no_mr,almt_ttp_pasien,diagnosa,url_foto_pasien,id_pm_tc_penunjang,asal_daftar from pm_tc_penunjang as a join tc_kunjungan as b on a.no_kunjungan=b.no_kunjungan join mt_master_pasien as c on b.no_mr=c.no_mr where flag_daftar is null and kode_bagian='050101'  $sqlAddSem order by tgl_daftar desc"  ;
	...
	$i = $pagenya->pagingVars["firstno"];
				...
				while ($tampil=$rsPaging->FetchRow()) {
					...
					$asal_daftar		=$tampil["asal_daftar"];
					...
					if($asal_daftar!=""){
						$asal_pasien=baca_tabel("mt_bagian","nama_bagian"," where kode_bagian='".$asal_daftar."'");
					}else{
						$asal_pasien="Registrasi";
					}
					...
					$tampil["asal_pasien"]=$asal_pasien;
					$tampil["no"]=$i;
