<?
	...
	$sql = "SELECT id_tc_po,kode_perusahaan,nama_apotik,no_po,tgl_po,tgl_kirim,tgl_konfirmasi,tgl_konfirm_apotik from tc_po_v where konfirm_apotik= 2 and kode_perusahaan='$id' $sqlAddSem" ;
	...
	$i = $pagenya->pagingVars["firstno"];
				...
				while ($tampil=$rsPaging->FetchRow()) {
					...
					$detail="<a href='#' title='Detail Barang Po' onclick=detailPOBatal('$id_tc_po','$kode_perusahaan')><i class='las la-list icon-lg text-success'></i></a>";
