...
<div id="Form">
	...
	<form id="idTambahLogistik" method="POST" action="#"  enctype="multipart/form-data">

		<div id="content">
			<div class="modal-header register-modal-head" style="background-color:#d92550">
				<h5 class="modal-title" style="color:white"><b>Form Logistik</b></h5>
			...
			<div class="col-sm-12">
				...
				<div class="row">
					<div class="col-lg-4">
						<label >Keterangan AM & PISS</label>
					</div>
					<div class="col-lg-8">
						<textarea class="form-control"  name="keterangan" readonly> <?= $tgl_input ?></textarea>
					</div>
				</div>
				<br>
				<div class="row">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card-footer" align="right">
							<button type="button" class="btn btn-success font-weight-bolder font-size-sm" onclick="AddLogistik()">Submit</button>
...
<script>
	function AddLogistik(){
		var dataform=$("#idTambahLogistik").serialize();
		$.ajax({
			type: "POST",
			url: '/03_logistik/logistik_projek_act.php',
			data: dataform,
