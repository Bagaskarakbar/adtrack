...
<div id="idContent">
<div class="card-header">List Project
</div>
<div class="main-card mb-3 card">
	<div class="card-body">
		<div class="tab-content">
		<div class="table-responsive">
				<table class="table table-separate table-head-custom table-checkable" data-toggle="table" data-url="/json/get_monitoring.php" data-pagination="true" data-trim-on-search="false"  data-search="true" data-sort-order="asc" data-side-pagination="server" data-total-field="count" data-data-field="items" id="kt_datatable1">
				<thead>
				<tr>
...
<script>
	function DetailProjek(a){
		$("#idContent").load('../05_monitoring/projek_detail.php',{id:a});
	}
</script>
